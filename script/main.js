...
const messages = [
    "TAP TAP Dimana Aja",
    "hey kamu",
    "aku pen bilang sesuatu nih",
    "coba pencet",
    "PENCET LAGIII",
    "semangat mencetnyaaa",
    "ini terakhir",
    "suerr",
    "TAPI BOONK",
    "awokawok",
    "Padahal aku cuma",
    "Mau Bilang",
    "*shaudikap kap kap leuy neuyy*",
    "artinya?",
    "yang semangat jalanin ibadah puasanya",
    "gabole prengat prengut",
    "okeyy?",
    "OH IYA",
    "aku punya pantun nihh",
    "kepasar beli ikan sepat",
    "cakeppssz",
    "pulangnya naik kadal",
    "KAGA BISA LAH KOCAKKK",
    "awkkawkkw",
    "MAAF YA KALO GARINGG"
];
